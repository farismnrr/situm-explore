export default defineNuxtConfig({
  ...
  runtimeConfig: {
    session: { password: process.env.NUXT_SESSION_PASSWORD || '', maxAge: 60 * 60 * 24 * 7, sessionHeader: 'x-nuxt-session', cookie: { secure: process.env.NUXT_SESSION_COOKIE_SECURE === 'true' } },
