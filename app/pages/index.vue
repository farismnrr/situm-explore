...
<template>
  <main class="landing-page">
    ...
    <header class="landing-hero">
      <div class="landing-container landing-hero-grid">
        <div class="landing-copy">
          <UBadge color="success" variant="soft"><span class="landing-status-dot" /> Indoor operations workspace</UBadge>
    ...
    <section id="analytics" class="landing-section"><div class="landing-container"><div class="landing-section-head"><UBadge variant="soft" color="neutral">Analytics</UBadge><h2>Operational answers, not vanity charts.</h2><p>Reports are grouped around concrete questions: who visited, where people stayed, how long positioning was active, where activity concentrates, and how the map viewer is used.</p></div><div class="landing-stats"><UCard v-for="stat in [{ label: 'Visitors today', value: '128', note: '↑ 8.4% vs yesterday' }, { label: 'Active positions', value: '24', note: 'across 2 floors' }, { label: 'Avg. stay time', value: '18m', note: 'main workspace geofence' }]" :key="stat.label"><span>{{ stat.label }}</span><strong>{{ stat.value }}</strong><small>{{ stat.note }}</small></UCard></div></div></section>
