...
<template>
  <div class="cartography-page space-y-6">
    ...
    <div v-else-if="String(status) === 'pending'" class="space-y-2" aria-label="Loading paths" aria-busy="true"><USkeleton class="h-16 w-full" /><USkeleton class="h-16 w-full" /></div>
