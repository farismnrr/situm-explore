...
function table(name: string) {
  ...
  if (!/^[a-zA-Z_][a-zA-Z0-9_]*$/.test(database) || !/^analytics_(visitors|positioning_time|geofencing_stay)$/.test(name)) throw new Error('Invalid analytics table configuration')
