...
Plan 031 owns Native Realtime Operations. Baseline v1 semantics remain device-position oriented unless Phase 0 proves more: the existing owner-scoped Nitro Realtime route returns position/device identity, source time, building/floor, accuracy, coordinates, and optional device ID. Do not invent person identities, online/idle/offline state, trajectories, remote markers/focus, or treat Share Live Location as Realtime Positions.
