...
Current planning authority is `plans/028-033-native-mobile-roadmap.md`, with Plan 032 active on `plan/032-web-native-handoff-distribution` and `plans/033-full-e2e-acceptance.md` terminal. Plan 032 Phase 0 froze the 768×600 Map Viewer capability threshold and environment-only mobile distribution configuration; implementation phases 1–7 remain in progress.
