...
Plan 031 implementation is complete on `plan/031-native-realtime-operations` at `84ef149`, pending separately authorized PR/review/merge. Baseline v1 semantics remain device-position oriented: the existing owner-scoped Nitro Realtime route returns position/device identity, source time, building/floor, accuracy, coordinates, and optional device ID. Do not invent person identities, online/idle/offline state, trajectories, remote markers/focus, or treat Share Live Location as Realtime Positions.
