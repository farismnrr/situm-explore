...
- Completed in Plan 022 branch: Phases 1–2 workspace ownership schema/migration and CRUD authorization.
- Current phase: Plan 022 Phase 3 encrypted workspace Situm configuration and safe metadata.
