...
- Current continuation is blocked because neither temporary key is available in the local environment/session; keys must not be recovered from Git history.
